...
def zetabc(zeta, compTimes, BOUNDARY):
    ...
    mod_boundary.copyBC((BOUNDARY.zetaClosedOrGradientBCIdx1.size//blockSize + 1,), (blockSize,), (zeta, BOUNDARY.zetaClosedOrGradientBCIdx1, BOUNDARY.zetaClosedOrGradientBCIdx2, BOUNDARY.zetaClosedOrGradientBCIdx1.size))
